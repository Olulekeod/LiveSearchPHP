...
<script>
// on keyup search results...as soon as the user starts typing
...
function searchData(val){
 ...
 $('#search-result-container').html('<div><img src="2.gif" width="50px;" height="50px"> <span style="font-size: 20px;">Please Wait...</span></div>');
...
<label > Live Search In PHP And MySQL With JQuery : </label><br><br>
